...
completed_cases_card = dbc.Card(
    ...
    style={"width": "20rem", "height": "15rem",'display': 'inline-block', "border": "10px lightgray solid"}
)
...
wait_cases_card = dbc.Card(
    ...
    style={"width": "20rem", "height": "15rem",'display': 'inline-block',
...
wait_50_card = dbc.Card(
    [
        dbc.CardBody(
            [
                html.P("Mean Waiting Time (weeks) 50 %le", className="card-title",
                       style = {"fontSize": "15px", "font": "Fira Sans"}),
    ...
    style={"width": "20rem", "height": "15rem",'display': 'inline-block',
           "justify-content": 'center', 'justify-content': 'center', "border": "10px lightgray solid"}
)
wait_90_card = dbc.Card(
    [
        dbc.CardBody(
            [
                html.P("Mean Waiting Time (weeks) 90 %le", className="card-title",
                       style = {"fontSize": "15px"}),
