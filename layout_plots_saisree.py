...
wait_cases_card = html.Div([
    ...
    style={"width":"100%","height":"120%","border": "12px lightgray solid","justify-content":"center"}
    )
],style={"width":"100%"})

completed_cases_card = html.Div([
    dbc.Card(
    [
    ...
    style={"width":"100%","height":"120%","border": "12px lightgray solid"}
    )
],style={"width":"100%"})

wait_50_card = html.Div([
    dbc.Card(
    [
...
app.layout= html.Div([  
        ...
        dbc.Row([
            ...
            dbc.Col([
                dbc.Row(proportion_cases),
                dbc.Row(fast_slow_button),
                dbc.Row(procedure_plot)
            ],width=4),
            dbc.Col(width=1),
            dbc.Col([
                dbc.Row(plot_map_object),
                dbc.Row(hosp_dropdown),
                dbc.Row(hosp_wait_comp_cases)
            ],width=4)
